...
import { ChainSettings } from '../../types/Cardano/ChainSettings';
...
export function decodeByronAddress(
  bytes: Buffer,
): AddressIntrospection<ByronAddressKind> | null {
  try {
    ...
    const protocolMagic = attributes.get(ByronAddressAttributes.networkMagic);
...
export function decodeJormungandrAddress(
  bytes: Buffer,
): AddressIntrospection<JormungandrAddressKind> | null {
